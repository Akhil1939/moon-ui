...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, MoonLibComponent, DropdownComponent, ReactiveFormsModule, GridComponent],
...
export class AppComponent {
  ...
  tableOptions: CommonGridOptions = {
    ...
    columns: [
      ...
      { label: 'Description', property: 'description', level: 0, colSpan: 2, type: 'string' },
      { label: 'Category', property: 'category', level: 0, type: 'string' },
      { label: 'Status', property: 'status', level: 0 },
      { label: 'Created By', property: 'createdBy', level: 0 },
      { label: 'Created Date', property: 'createdDate', level: 0, type: 'date' },
      ...
      { label: '', property: 'prop1', level: 1, colSpan: 4 },
      { label: 'Location', property: 'location', level: 1 },
      { label: '', property: 'prop2', level: 1, colSpan: 5 },
